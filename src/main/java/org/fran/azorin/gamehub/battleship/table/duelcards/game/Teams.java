package org.fran.azorin.gamehub.battleship.table.duelcards.game;

import org.fran.azorin.gamehub.battleship.table.duelcards.character.Team;
...
public class Teams {
	...
	public Team createTeam() {
		...
		//REHACER
		//1� ELEGIMOS EQUIPO, SE CREARA UN OBJETO DE ESE EQUIPO
		//2� A�ADIREMOS PJS DE ESE TIPO DE EQUIPO HASTA A�ADIR 3
			...
			if(equipo == 'r' || equipo == 'R' || equipo == 'e' || equipo == 'E') {
				...
				if(equipo == 'E' || equipo == 'e') {
					...
					if(totalR < 3) {
						...
						System.out.println("No necesitamos sangre nueva en los Rebeldes, a�ade algun enemigo con el que acabar");
					}
