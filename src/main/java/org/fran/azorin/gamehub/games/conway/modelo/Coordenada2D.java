...
import org.fran.azorin.gamehub.games.conway.modelo.excepciones.ExcepcionCoordenada2DIncorrecta;
...
public class Coordenada2D extends Coordenada{
	 ...
	 */
	public Coordenada2D(Coordenada coordenada) throws ExcepcionArgumentosIncorrectos{
		
		Coordenada2D c = (Coordenada2D) coordenada;
