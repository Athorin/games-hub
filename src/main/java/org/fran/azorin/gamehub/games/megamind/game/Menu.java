package org.fran.azorin.gamehub.games.megamind.game;
...
/**
 * Class org.fran.azorin.gamehub.megamind.game.Menu for Megamind
 * @author Fran Azorin
 *
 */
public class Menu {
	...
	public static void menu() {
		...
		System.out.println("-----------------------------------------\n");
		System.out.println("   org.fran.azorin.gamehub.megamind.game.Menu");
		System.out.println("----------");
